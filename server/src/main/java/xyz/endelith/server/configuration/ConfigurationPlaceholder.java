...
public enum ConfigurationPlaceholder { 
    ...
    MINECRAFT_VERSION_NAME("minecraft-version-name", ApiVersion.LATEST.name()),
    MINECRAFT_PROTOCOL_VERSION("minecraft-protocol-version", String.valueOf(ApiVersion.LATEST.protocolVersion()));
